...
process realign_and_iqtree_08 {
  //  echo  true
   ...
   output:
   file("08_realigned") into (realigned_with_outgroups_ch_1,realigned_with_outgroups_ch_2, realigned_with_outgroups_ch_3) 
   file("09_realigned_trees") into (realigned_trees_ch_1, realigned_trees_ch_2, realigned_trees_ch_3)
...
process prune_paralogs_MO_09 {
  ...
  output:
  file("10_prune_MO_trees") into MO_ch

  script:
  """
  mkdir 10_prune_MO_trees
...
process prune_paralogs_RT_10 {
  ...
  output:
  file("11_prune_RT_trees") into RT_ch

  script:
  """
  mkdir 11_prune_RT_trees
...
process prune_paralogs_MI_11 {
  ...
  output:
  file("12_prune_MI_trees") into MI_ch

  script:
  """
  mkdir 12_prune_MI_trees
...
process write_alignment_subset_MO_12 {
  ...
  output:
  file("13_selected_alignments_MO") into selected_alignments_MO_ch

  script:
  """
  mkdir 13_selected_alignments_MO
  # python /Users/chrisjackson/PycharmProjects/Yang-and-Smith-RBGV-scripts/07_subset_fasta_from_tree.py
  python /Yang-and-Smith-RBGV-scripts/07_subset_fasta_from_tree.py \
  ${MO_folder} \
  .tre \
...
process write_alignment_subset_RT_13 {
  ...
  output:
  file("14_selected_alignments_RT") into selected_alignments_RT_ch

  script:
  """
  mkdir 14_selected_alignments_RT
  # python /Users/chrisjackson/PycharmProjects/Yang-and-Smith-RBGV-scripts/07_subset_fasta_from_tree.py
  python /Yang-and-Smith-RBGV-scripts/07_subset_fasta_from_tree.py \
  ${RT_folder} \
  .tre \
...
process write_alignment_subset_MI_14 {
  ...
  output:
  file("15_selected_alignments_MI") into selected_alignments_MI_ch

  script:
  """
  mkdir 15_selected_alignments_MI
  # python /Users/chrisjackson/PycharmProjects/Yang-and-Smith-RBGV-scripts/07_subset_fasta_from_tree.py
  python /Yang-and-Smith-RBGV-scripts/07_subset_fasta_from_tree.py \
  ${MI_folder} \
  .tre \
...
process strip_names_and_realign_MO_15 {
  // echo true
  label 'in_container'
  publishDir "${params.outdir}", mode: 'copy', pattern: '16_alignments_stripped_names', saveAs: { "16_alignments_stripped_names_MO"}
  publishDir "${params.outdir}", mode: 'copy', pattern: '17_alignments_stripped_names_realigned', saveAs: { "17_alignments_stripped_names_MO_realigned"}
...
process strip_names_and_realign_RT_16 {
  echo true
  label 'in_container'
  publishDir "${params.outdir}", mode: 'copy', pattern: '16_alignments_stripped_names', saveAs: { "18_alignments_stripped_names_RT"}
  publishDir "${params.outdir}", mode: 'copy', pattern: '17_alignments_stripped_names_realigned', saveAs: { "19_alignments_stripped_names_RT_realigned"}
...
process strip_names_and_realign_MI_17 {
  echo true
  label 'in_container'
  publishDir "${params.outdir}", mode: 'copy', pattern: '16_alignments_stripped_names', saveAs: { "20_alignments_stripped_names_MI"}
  publishDir "${params.outdir}", mode: 'copy', pattern: '17_alignments_stripped_names_realigned', saveAs: { "21_alignments_stripped_names_MI_realigned"}
